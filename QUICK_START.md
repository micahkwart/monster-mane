# 🎮 Monster Mane - Quick Start Guide
## Copy-Paste Instructions to Get the Game Running

This guide gives you everything you need in simple copy-paste steps!
...
Create these 2 files in a new folder:

#### File 1: `fighting_game.py`
Copy ALL of this code and save as `fighting_game.py`:
...
Copy this single line and save as `requirements.txt`:
...
Open Command Prompt (Windows) or Terminal (Mac/Linux) in your game folder and run:
...
### Objective
Get close to your opponent and attack! First player to reduce the other's health to 0 wins!
...
Just 4 steps:
1. ✅ Install Python
2. ✅ Create 2 files (fighting_game.py and requirements.txt)
3. ✅ Run: `pip install ursina==7.0.0`
4. ✅ Run: `python fighting_game.py`

**OR** just download the repository ZIP, extract, and run `launch_game.bat` (Windows) or `launch_game.sh` (Mac/Linux)!
